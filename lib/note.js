...
TeoriaNote.prototype = {
  ...
  */
  ...
  interval: function(interval) {
    if (interval instanceof TeoriaInterval)
      return new TeoriaNote(vector.add(this.coord, interval.coord));
    else if (interval instanceof TeoriaNote)
      return new TeoriaInterval(vector.sub(this.coord, interval.coord));
  },
  ...
  scaleDegree: function(scale) {
    ...
    return scale.scale.reduce(function(index, current, i) {
      var coord = TeoriaInterval.toCoord(current).coord;
